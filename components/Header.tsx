...
export default function Header() {
  return (
    <header className="flex justify-center items-center px-8 py-6 bg-gradient-to-b from-black/80 to-transparent">
      <div className="flex flex-col items-center text-yellow-500 font-bold">
        <Image src="/logo.png" alt="Logo" width={80} height={80} />
        <span className="text-6xl">Rodrigues Eletricista</span>
        <span className="text-4xl">Segurança e Qualidade</span>
